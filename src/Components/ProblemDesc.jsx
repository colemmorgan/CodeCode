import { doc, getDoc, runTransaction, updateDoc, arrayUnion,arrayRemove } from "firebase/firestore";
    ...
    <div className="row-span-5 container relative">
      {currentProblem && (
        <div className="absolute right-2 top-5 flex text-lg">
          ...
          <div className="flex items-center text-dull mr-3" style={{ color: starred ? "rgb(253,224,71)" : "" }} >
      ...
      <div className="content ">
        ...
        <div className="flex mt-4 text-gray-700">
          ...
          <div className="bg-yellow-300 font-semibold py-1.5 px-4 flex items-center rounded-md mr-2 cursor-pointer text-sm" onClick={handleStar}>
            <span className="pb-0.5 mr-1">
              {" "}
              <FaStar />
            </span>
